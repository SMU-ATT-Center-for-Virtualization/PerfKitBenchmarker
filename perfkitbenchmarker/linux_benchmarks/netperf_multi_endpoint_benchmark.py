...
BENCHMARK_NAME = 'netperf_multi_endpoint'
BENCHMARK_CONFIG = """
netperf_multi_endpoint:
...
REMOTE_SCRIPT = 'netperf_multi_endpoint_test.sh'
...
def RunNetperfAggregate(vm, server_ips):
  ...
  vm.RemoteCommand(
      ...
      'export PATH=$PATH:. && '
      'chmod +x netperf_multi_endpoint_test.sh && '
      './netperf_multi_endpoint_test.sh',
      ignore_failure=True,
      should_log=True,
      login_shell=False,
      timeout=1200)
